...
public class MemberWriteController {
	...
	public String submit(
			@ModelAttribute("command") @Valid MemberVO vo,
	...
	public void initBinder(WebDataBinder binder) {
		//true이면 요청 파라미터의 값이 null이거나 빈 문자열("")일 때
		//변환 처리를 하지 않고 null 값으로 할당.
		//false이면 변환 과정에서 에러가 발생하고
		//에러 코드로 "typeMismatch"가 추가 됨
